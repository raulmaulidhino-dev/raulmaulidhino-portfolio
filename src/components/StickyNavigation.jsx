...
export default function StickyNavigation() {
    return (
        <section className="sticky-nav sticky top-4 mx-4 mb-10 rounded-[17px] bg-dark-blue border-t-2 border-t-neon-magenta border-r-2 border-neon-magenta border-l-2 border-l-neon-cyan border-b-2 border-b-neon-cyan lg:hidden z-[99]
        ...
        " data-aos="zoom-in-down">
                <nav className="rounded-[17px]">
                    <ul className="bg-dark-blue text-md rounded-[17px] p-4 flex justify-around items-center gap-8">
                        ...
                        <li><a href="#portfolio" title="Portfolio"><Portfolio size="24" className="transition-transform duration-300 ease-in-out transform hover:scale-150 hover:text-neon-magenta" /></a></li>
                        <li><a href="#contact_me" title="Contact Me"><ContactMe size="24" className="transition-transform duration-300 ease-in-out transform hover:scale-150 hover:text-neon-cyan" /></a></li>
                    </ul>
                </nav>
        </section>
    )
