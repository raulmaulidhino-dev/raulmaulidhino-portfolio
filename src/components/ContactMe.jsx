...
export default function ContactMe() {
    return (
        <footer id="contact_me" className="px-10 py-[6rem]">
            <h2 className="text-neon-cyan font-extrabold text-center text-5xl font-special md:text-6xl mb-10" data-aos="zoom-in">CATCH ME!</h2>
            ...
            <section className="flex gap-4 justify-center items-center">
                <a href="mailto:raul.maulidhino@gmail.com" target="_blank" data-aos="fade-up" data-aos-duration="1500" data-aos-easing="ease-in-out-sine"><Mail size="42" /></a>
