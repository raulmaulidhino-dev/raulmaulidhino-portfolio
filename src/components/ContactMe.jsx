    ...
    return (
        <footer id="contact_me" className="px-10 py-[6rem]">
            ...
            <section className="flex gap-4 justify-center items-center">
                <a href="mailto:raul.maulidhino@gmail.com" target="_blank" data-aos="fade-up" data-aos-duration="1500" data-aos-easing="ease-in-out-sine"><Mail size="42" className="transition-transform duration-300 ease-in-out transform hover:scale-125 hover:text-neon-magenta" /></a>
                ...
                <a href="https://github.com/raulmaulidhino-dev" target="_blank" data-aos="fade-up" data-aos-duration="1500" data-aos-easing="ease-in-out-sine" data-aos-delay="1500"><Github size="42" className="transition-transform duration-300 ease-in-out transform hover:scale-125 hover:text-neon-cyan" /></a>
            </section>
        </footer>
    )
}