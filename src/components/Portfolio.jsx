...
export default function Portfolio() {
    return (
        <section id="portfolio" className="py-10 px-4 md:px-[6rem] flex flex-col gap-4">
            <h2 className="text-neon-magenta font-extrabold text-center text-5xl font-special md:text-6xl mb-10">PORTFOLIO</h2>
            <nav>
